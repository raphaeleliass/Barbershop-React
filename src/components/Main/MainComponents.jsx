...
function MainComponents({ divClass, img, text }) {
  return (
    <div className={`flex flex-col gap-4 ${divClass}`}>
      ...
      >
        <div className="flex h-full items-center justify-center rounded-xl bg-white bg-opacity-60">
          <div className="mx-2 my-2 flex flex-col items-center justify-center rounded-xl bg-gray-100 p-6 md:mx-8 md:my-0 md:flex-row md:p-12">
            <div className="flex flex-col gap-4 items-center justify-center text-center md:mr-14 lg:mr-32">
              <img
            ...
            <div className="md:w-2/3">
              ...
              <p className="text-sm text-neutral-400 font-semibold">{text}</p>
            </div>
          </div>
        </div>
      </div>
